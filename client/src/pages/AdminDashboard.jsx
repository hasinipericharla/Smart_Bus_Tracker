  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {error && (
          <div style={{
            width: '100%', background: '#FFF0F0', border: '1.5px solid #F5C6C6',
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
            ...
            }}>Admin ID / Email</label>
            <div style={{ position: 'relative' }}>
              <input
                type="text"
                placeholder="admin@busnav.com"
                value={email}
              ...
              <span style={{
                ...
                transform: 'translateY(-50%)', fontSize: '15px', color: '#8898A9'
              }}>👤</span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '-4px' }}>
            <label style={{
              ...
              fontSize: '13px', color: '#6B7E9B', fontWeight: '600', cursor: 'pointer'
            }}>
              <input
                type="checkbox"
                checked={remember}
          ...
          <button
            ...
            style={{
              ...
              transition: 'background 0.18s, transform 0.12s', letterSpacing: '0.02em'
            }}
          >
            Sign In as Admin
          </button>
          ...
          <button
            ...
            onMouseLeave={e => {
              ...
              e.currentTarget.style.borderColor = '#D8E2EE';
            }}
            style={{
